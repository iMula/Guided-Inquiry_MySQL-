...
CREATE TABLE dream_cars2(
make VARCHAR(20),
model VARCHAR(20),
year INT
);

INSERT INTO dream_cars2 (make, model, year) 
VALUES 
('Porsche','911', 2022), 
...
ALTER TABLE dream_cars2 ADD price INT;
ALTER TABLE dream_cars2 ADD color VARCHAR(20);

INSERT INTO dream_cars2 (make, model, year, price, color) 
VALUES
...
SELECT make, model, 
CONCAT (make, ' ', model) 
AS car FROM dream_cars2;

SELECT make, COUNT(*) FROM dream_cars2 GROUP BY make;
